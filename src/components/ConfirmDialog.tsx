...
export default function ConfirmDialog() {
  ...
  const isDestructive = confirmDialog.title.includes('删除') || confirmDialog.title.includes('清空') || confirmDialog.title.includes('ئۆچۈرۈش') || confirmDialog.title.includes('تازىلا')
  ...
  const cancelText = confirmDialog.cancelText ?? t('cancel')

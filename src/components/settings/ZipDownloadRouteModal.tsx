...
export function getZipDownloadRouteOptions(): Array<{ route: ZipDownloadRoute; label: string; description: string }> {
  return [
    { route: 'task-selection', label: t('zipRouteTaskSelection'), description: t('zipRouteTaskSelectionDesc') },
    { route: 'favorite-collection-selection', label: t('zipRouteFavoriteSelection'), description: t('zipRouteFavoriteSelectionDesc') },
    { route: 'image-context-menu-all', label: t('zipRouteContextMenu'), description: t('zipRouteContextMenuDesc') },
    { route: 'task-detail-all', label: t('zipRouteTaskDetailAll'), description: t('zipRouteTaskDetailAllDesc') },
    { route: 'task-detail-partial', label: t('zipRouteTaskDetailPartial'), description: t('zipRouteTaskDetailPartialDesc') },
    { route: 'agent-round-all', label: t('zipRouteAgentRound'), description: t('zipRouteAgentRoundDesc') },
  ]
}
...
export default function ZipDownloadRouteModal({
  ...
  useUiLang()
  const routeOptions = getZipDownloadRouteOptions()
  return createPortal(
    <div
      data-no-drag-select
      ...
      >
        <div className="shrink-0 p-6 pb-2">
          <div className="mb-3 flex items-center justify-between gap-4">
            <h3 className="text-base font-bold text-gray-800 dark:text-gray-100">{t('zipDownloadTitle')}</h3>
            <button
              type="button"
              onClick={onClose}

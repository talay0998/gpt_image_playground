        ...
        <div className="flex h-40">
          ...
          <div className="flex-1 p-3 flex flex-col min-w-0">
            <div className="flex-1 min-h-0 mb-2 overflow-hidden">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">{t('tasksCount', { n: card.tasks.length })}</p>
            </div>
            <div className="mt-auto flex items-center justify-end gap-1">
              {!isVirtualAll && card.collection && (
                <>
                  <FavoriteActionButton
                    tooltip={isDefault ? t('unsetDefaultCollection') : t('setAsDefaultCollection')}
                    onClick={(e) => {
                      e.stopPropagation()
                  ...
                  <FavoriteActionButton
                    tooltip={canDelete ? t('deleteFavoriteCollection') : t('keepAtLeastOneCollection')}
                    disabled={!canDelete}
                    onClick={(e) => {
                      e.stopPropagation()

...
export default function InputParamsPanel({
  ...
  return (
    <div className={`grid ${cols} gap-2 text-xs flex-1`}>
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{t('paramSize')}</span>
        <button
          type="button"
        ...
        <ButtonTooltip
          ...
          text={isFalTextToImage
            ? <>{t('falAutoSizeHintLead')} <code className="rounded bg-white/10 px-1 py-0.5 font-mono">auto</code> {t('falAutoSizeHintTail')}</>
            : t('codexCliSizeHint')}
        />
      </label>
      <label
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{t('paramQuality')}</span>
        <Select
        ...
        <ButtonTooltip
          ...
          text={isFalProvider ? <>{t('falAutoQualityHintLead')} <code className="rounded bg-white/10 px-1 py-0.5 font-mono">auto</code> {t('falAutoQualityHintTail')}</> : t('codexCliQualityHint')}
        />
      </label>
      <label className="flex flex-col gap-0.5">
        <span className="text-gray-400 dark:text-gray-500 ml-1">{t('paramFormat')}</span>
        <Select
      ...
      {showTransparentOutputControl && (
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{t('transparentBg')}</span>
          <Select
      ...
      {!showTransparentOutputControl && (
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{t('compressionLabel')}</span>
          <input
          ...
          <ButtonTooltip
            ...
            text={isFalProvider ? t('compressionNotSupportedHint') : t('compressionFormatHint')}
          />
        </label>
      )}
      <label
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{t('moderationLabel')}</span>
        <Select
        ...
        <ButtonTooltip
          ...
          text={t('moderationNotSupportedHint')}
        />
      </label>
      <label
        className="relative flex flex-col gap-0.5"
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{t('paramCount')}</span>
        <input
          value={nInput}
        ...
        <ButtonTooltip visible={streamConcurrentByN && streamConcurrentHint.visible && !nLimitHint.visible} text={t('streamConcurrentHint')} />
      </label>
    </div>
  )
}

...
export default function SearchBar() {
  ...
  const favoriteTooltip = activeFavoriteCollectionId ? t('favoriteBack') : filterFavorite ? t('favoriteExit') : t('favorite')
  ...
  const handleClearFailed = () => {
    ...
    setConfirmDialog({
      title: t('clearFailedTitle'),
      message: t('clearFailedMsg', { n: failedTaskCount }),
    ...
    <div ref={rootRef} data-no-drag-select className="mt-6 mb-4 flex gap-3">
          ...
          <>
            <div className="relative w-[88px]">
              <Select
                ...
                options={[
                  ...
                  { label: t('statusError'), value: 'error' },
                ]}
            ...
            {isFailedFilter && (
              <button
                ...
                title={failedCount > 0 ? t('clearFailedCount', { n: failedCount }) : t('noFailed')}
                aria-label={failedCount > 0 ? t('clearFailedCount', { n: failedCount }) : t('noFailed')}
      ...
      <div className="relative z-10 flex-1">
        ...
        <input
          ...
          type="text"
          placeholder={inCollectionOverview ? t('searchCollection') : t('searchPrompt')}
